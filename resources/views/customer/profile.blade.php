            ...
            <form method="POST" id="myForm">
              ...
              <div class="row">
                ...
                <div class="card-footer text-center row">
                    <div class="col-sm-6">
                        <button type="submit" name="action_button" id="action_button"  class="btn bg-gradient-primary">Update Information</button>
                    </div>
                    <div class="col-sm-6">
                        ...
                        <button type="button" class="btn bg-gradient-warning" id="btn_change_password">Change Password</button>
                    </div>
                </div>
            </form>
    </div>
...
$('#cpForm').on('submit', function(event){
    ...
    var action_url = "/customer/profile/change_password/" + id;
    var type = "PUT";
...
$('#myForm').on('submit', function(event){
    ...
    var action_url = "/customer/profile";
    var type = "PUT";
